...
export const projects = [
  ...
  {
    name: "Dataplex",
    desc: "The project is aimed to create a Data as a Service platform to get raw data, store it in a secure and accessible database and sell transformed data as insightful findings. <br/><b>Tools used<b/>: Airbyte + Azure + PowerBI",
    github:
      "https://github.com/R-otato/Dataplex/blob/main/RyanLiam_Dashboards.pdf",
  },
  {
    name: "SG Bus Timing Tracker",
    desc: "The project is aimed to make use of a front-end and an analytics automation platform, Alteryx, to provide commuters with real-time information on when a bus will arrive at their selected bus stop. <br/><b>Tools used<b/>: Alteryx Designer + AdobeXD",
    github:
  ...
  },
  {
    ...
    desc: "The objective of this project is to enhance customer retention and drive growth for the food truck business Tasty Bytes by integrating machine learning model predictions and key insights about their customer into a streamlit application. <br/><b>Tools used<b/>: Jupyter + Snowflake + Streamlit",
  },
];
